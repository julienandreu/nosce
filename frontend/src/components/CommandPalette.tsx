    ...
    >
      ...
      <div class="relative w-full max-w-xl bg-latte-base dark:bg-mocha-base border border-latte-surface0 dark:border-mocha-surface0 rounded-xl shadow-2xl overflow-hidden">
        ...
        <div class="flex items-center px-4 border-b border-latte-surface0 dark:border-mocha-surface0">
          <svg class="w-5 h-5 text-latte-overlay0 dark:text-mocha-overlay0 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="max-h-[50vh] overflow-y-auto">
          {searching && (
            <div class="px-4 py-3 text-sm text-latte-subtext0 dark:text-mocha-subtext0">
              Searching...
            </div>
          )}
                  ...
                  {hits.map((hit) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <svg class="w-4 h-4 text-latte-overlay0 dark:text-mocha-overlay0 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
