...
export function ProfileProvider({ profiles, children }: ProfileProviderProps): preact.JSX.Element {
  ...
  return (
    <ProfileContext.Provider value={{ profileId, setProfileId, profiles, currentProfile }}>
      {children}
